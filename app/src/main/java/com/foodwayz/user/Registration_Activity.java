 ...
 */
public class Registration_Activity extends AppCompatActivity implements View.OnClickListener, IHttpRequestCallBack {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.txt_sign_in_resto:
                Intent intent1 = new Intent(Registration_Activity.this, resturent_Registration_Activity.class);
    ...
    private void StartProcess() {
        if (Utils.isNetworkAvailable(Registration_Activity.this)) {
...
//                startHttpRequest();
    ...
    private void startHttpRequest() {
        ...
        CustomPostRequest httpRequest = new CustomPostRequest(Registration_Activity.this, getResources().getString(R.string.URL_REGISTER), jsonObject);
        httpRequest.execute();
    }
